...
export const metadata: Metadata = {
  title: "Luxe Haven Hotel - 5-Star Luxury Accommodation",
  description: "Experience unparalleled luxury at Luxe Haven Hotel. Premium rooms, world-class amenities, fine dining, and exceptional service in the heart of the city.",
  keywords: "luxury hotel, 5-star accommodation, premium suites, spa, fine dining, concierge service, business travel",
  metadataBase: new URL("https://luxehavenhotel.com"),
  alternates: {
    canonical: "https://luxehavenhotel.com"
  },
  openGraph: {
    title: "Luxe Haven Hotel - 5-Star Luxury Experience",
    description: "Indulge in unparalleled elegance with luxury rooms, world-class amenities, and personalized service.",
    ...
    images: [
      {
        ...
        alt: "Luxe Haven Hotel elegant lobby"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Luxe Haven Hotel - 5-Star Luxury Experience",
    description: "Experience luxury redefined with premium accommodations and exceptional service.",
